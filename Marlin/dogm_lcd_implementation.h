...
// u8g.print(ftostr31ns(current_position[X_AXIS]));
 u8g.print(ftostr31ns(float(st_get_position(X_AXIS))/axis_steps_per_unit[X_AXIS]));
...
// u8g.print(ftostr31ns(current_position[Y_AXIS]));
 u8g.print(ftostr31ns(float(st_get_position(Y_AXIS))/axis_steps_per_unit[Y_AXIS]));
...
// u8g.print(ftostr31(current_position[Z_AXIS]));
 u8g.print(ftostr31(float(st_get_position(Z_AXIS))/axis_steps_per_unit[Z_AXIS]));
 u8g.setColorIndex(1);	// black on white
